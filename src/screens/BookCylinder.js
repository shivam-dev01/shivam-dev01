...
export default function BookCylinder() {
  ...
  const fetchOperatord = () => {
    const apiParams = {
      url: apiEndpoints.FETCH_GAS_OPERATORE,
      requestMethod: 'get',
      response: res => {
        console.log(res);
  ...
  return (
    <View style={Styles.body}>
      <Text style={Styles.book_cylinder_text}>BookCylinder</Text>
      ...
      <View style={{alignSelf: 'center', marginTop: 20}}>
        ...
        <Text style={Styles.bill_details}>Due Date - {billFetch.DueDate}</Text>
      </View>
