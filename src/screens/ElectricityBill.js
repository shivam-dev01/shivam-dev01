...
export default function BookCylinder() {
  ...
  const fetchOperatord = () => {
    const apiParams = {
      url: apiEndpoints.FETCH_ELECTRICITY_OPERATORE,
      requestMethod: 'get',
      response: res => {
        console.log(res);
  ...
  const payBill = () => {
    const apiParams = {
      ...
      input: {
        ...
        otherValue: 'ssss',
        billPaymentNumber: billFetch.BillNumber,
      },
    };
    Api.callApi(apiParams);
  };
  ...
  return (
    <>
      <View style={Styles.body}>
        <Text style={Styles.book_cylinder_text}>Electricity Bill</Text>
        ...
        <View style={Styles.first_drop_down}>
          ...
          <Dropdown
            ...
            labelField="displayValue"
            valueField="value"
            placeholder={!operatoreIsFous ? 'Select Board' : '...'}
            searchPlaceholder="Search..."
